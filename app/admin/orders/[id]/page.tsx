...
import { ORDER_STATUSES, type OrderStatus } from "../order-stats-opti";
import { OrderStatusForm } from "../order-stats-from";
                  ...
                  <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                      <div className="flex items-center gap-3">
                        ...
                        <Badge
                          variant="outline"
                          className={statusBadgeClass(result.data.status)}
                        >
                    ...
                    <OrderStatusForm
                      ...
                      initialStatus={normalizeStatus(result.data.status)}
                    />
                  </div>
                  ...
                  <div className="grid gap-6 lg:grid-cols-3">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="rounded-lg border p-4">
                        ...
                        <div className="mt-3 space-y-2 text-sm text-muted-foreground">
                          <div>{result.data.addressLine1}</div>
                          {result.data.addressLine2 && (
                            <div>{result.data.addressLine2}</div>
                          )}
                          <div>
                            {result.data.city}
                      ...
                      <div className="rounded-lg border p-4">
                        ...
                        <div className="mt-3 space-y-2 text-sm text-muted-foreground">
                          ...
                          <div>Subtotal: ৳{result.data.subtotal}</div>
                          <div>Shipping: ৳{result.data.shippingCost}</div>
