...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-50 shadow-lg">
            {/* Top Bar */}
            <div className="top-bar-gradient bg-black text-white text-xs sm:text-sm h-9 sm:h-10 flex items-center justify-between px-3 sm:px-4 md:px-12 lg:px-24 relative overflow-hidden">
                ...
                <div className="hidden sm:block text-center flex-1 relative z-10">
                    <p className="font-normal leading-6 tracking-wide">
                        ...
                        Get <span className="font-bold text-yellow-400">+880 1701635619</span> aminur rahman suhan
            ...
            {/* Main Bar */}
                {/* Mobile Logo */}
            <div className="header-glass h-14 sm:h-16 bg-white md:h-20 lg:h-18 flex items-center justify-between px-3 sm:px-4 md:px-8 lg:px-12 xl:px-24 border-b border-gray-200/50 relative">
                ...
                <div className="flex items-center space-x-2 sm:space-x-3 lg:space-x-4 z-20">
                    ...
                    <Link href="/cart" className="icon-bounce p-1.5 sm:p-2 lg:p-2.5 cursor-pointer hover:from-indigo-50 hover:to-purple-50 transition-all duration-300 relative group">
                        ...
                        <div className="badge-pulse absolute -top-0.5 -right-0.5 w-4 h-4 lg:w-5 lg:h-5 bg-gradient-to-br from-pink-600 to-rose-600 rounded-full flex items-center justify-center text-white text-[10px] lg:text-xs font-bold ring-2 ring-white shadow-lg">{cartItemCount}</div>
                    </Link>
