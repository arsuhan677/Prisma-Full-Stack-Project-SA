...
export default function ProductCard({ product, variant = 'grid' }: ProductCardProps) {
            ...
            <div className="group bg-white overflow-visible shadow-md transition-shadow duration-300">
                <div className="relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-4">
                        <button className="bg-white text-gray-900 px-4 py-2 flex items-center space-x-2 hover:bg-gray-100 transition-colors text-base font-semibold shadow-2xl transform group-hover:scale-105 duration-300 cursor-pointer">
    ...
    return (
        <div className="group p-2.5 hover:bg-gray-100 rounded-lg">
            <div className="relative overflow-hidden rounded-lg bg-r">
                {product.badge && (
            ...
            <div className="mt-4">
                ...
                <div className="flex-col justify-between sm:flex items-baseline space-x-2 mt-1">
