  ...
  return (
    <div className="container mx-auto">
      <div className="w-full pb-20 px-3 text-white">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mt-10">
          ...
          <div className="w-full space-y-4">
            ...
            <div className="text-zinc-500 py-2">
              <div className="flex items-start gap-2">
                <span>
                  ...
                  >
                    <g clipPath="url(#clip0_1141_1885)">
                      ...
                      />
                      <path
                        d="M11.5244 20.3101C11.5927 20.26 11.6742 20.2153 11.7365 20.1517C14.7388 17.0869 17.7379 14.018 20.7443 10.9573C21.1352 10.5592 21.3168 10.1097 21.3148 9.54576C21.3049 7.0449 21.3115 4.54405 21.3122 2.0432C21.3122 1.95248 21.3122 1.86108 21.3122 1.74599C21.8217 1.73854 22.2226 1.93758 22.5526 2.29572C22.8594 2.6288 22.9979 3.03501 22.9986 3.48725C23.0012 5.86556 23.0006 8.24456 22.9992 10.6229C22.9992 11.1381 22.8091 11.5734 22.4532 11.9369C19.6735 14.7756 16.8984 17.6184 14.1133 20.4509C13.346 21.2315 12.244 21.1767 11.5251 20.3108L11.5244 20.3101Z"
                        fill="#70747D"
                      />
                    </g>
                    <defs>
                ...
                <p>
                  ...
                  Off on orders above
                  <span className="text-lg font-semibold"> TK. 2000</span>, Use
                  Code:
            ...
            <div className="flex items-center gap-4 mt-4">
              ...
              <button
                onClick={() =>
                  dispatch(addToCartWithQty({ product, quantity: qty }))
                }
            ...
            <div className="border-b border-slate-200 pb-4">
              ...
              <div
                className={`transition-all duration-300 overflow-hidden ${
                  openReviews ? "max-h-[500px] mt-4" : "max-h-0"
                }`}
              >
                {/* Reviews */}
        ...
        {/* Extra Info */}
        <div className="border-b border-slate-200 pb-4 mt-6">
          <button
          ...
          <div
            className={`transition-all duration-300 overflow-hidden ${
              openShipping ? "max-h-[500px] mt-4" : "max-h-0"
            }`}
          >
            <p className="text-gray-700 text-lg leading-relaxed">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Neque commodi, omnis facere nam maxime odio perspiciatis eos, tempora nesciunt minus totam sunt iure repellendus quae, autem voluptate. Accusamus, explicabo modi. Quae quod enim id minus voluptates numquam ex dignissimos, assumenda veniam fuga aliquam itaque optio quibusdam, laboriosam praesentium temporibus perferendis!
            </p>
          </div>
        </div>
      </div>
