...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-50 shadow-lg">
            ...
            {/* Main Bar */}
            <div className="header-glass h-14 bg-white sm:h-16 md:h-20 lg:h-18 flex items-center justify-between px-3 sm:px-4 md:px-8 lg:px-12 xl:px-24 border-b border-gray-200/50 relative">
                {/* Mobile Logo */}
                ...
                <div className="flex items-center space-x-2 sm:space-x-3 lg:space-x-4 z-20">
                    ...
                    {/* Compare */}
                    <button className="icon-bounce p-1.5 sm:p-2 lg:p-2.5 hover:from-indigo-50 hover:to-purple-50 transition-all duration-300 relative group">
